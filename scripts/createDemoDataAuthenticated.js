...
// File: scripts/createDemoDataAuthenticated.js
// Script to create demo companies and jobs with authentication
...
async function createGraphQLData() {
  ...
  console.log('🚀 Creating demo GraphQL data with authentication...\n');
